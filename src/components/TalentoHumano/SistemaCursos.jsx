...
import { sendCursosEmails } from '../../api';
import "./SistemaCursos.css";

const SistemaCursos = ({ onVolver, usuario }) => {
  ...
  // Columnas requeridas para Cursos Obligatorios
  ...
  const downloadTemplate = () => {
    try {
      ...
      const data = [
        {
          ...
          "NOMBRE": "Juan Pérez",
          "FECHA_LIMITE": "15/12/2024",
          "DIRIGIDO_A": "Personal asistencial",
          "Asunto": "Recordatorio Cursos Obligatorios",
          "CURSO_1": "Bioseguridad",
          "ESTADO_1": "Pendiente",
          "FECHA_1": "15/12/2024",
          "CURSO_2": "RCP Básico",
          "ESTADO_2": "Completado",
          "FECHA_2": "10/11/2024",
          "CURSO_3": "Manejo de Desechos",
          "ESTADO_3": "Pendiente",
          "FECHA_3": "20/12/2024",
          "CURSO_4": "Ética Médica",
          "ESTADO_4": "En Proceso",
          "FECHA_4": "05/12/2024",
          "ENLACE_SUBIDA_CERTIFICADOS": "https://forms.google.com/ejemplo",
          "Fecha Programada": "",
          "Hora Programada": ""
        },
        {
          ...
          "DIRIGIDO_A": "Personal administrativo",
          "Asunto": "Recordatorio Cursos Obligatorios",
          "CURSO_1": "Bioseguridad",
          "ESTADO_1": "Pendiente",
          "FECHA_1": "20/12/2024",
      ...
      XLSX.utils.book_append_sheet(wb, ws, "Plantilla Cursos");
      
      // Crear archivo Excel
      const excelBuffer = XLSX.write(wb, { bookType: 'xlsx', type: 'array' });
      const blob = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
      
      saveAs(blob, 'Plantilla_Cursos.xlsx');
  ...
  const sendEmails = async (file, isRealSend) => {
    try {
      ...
      // Llamar a la API
      const result = await sendCursosEmails(
        file,
        usuario.id,
  ...
  return (
    <div className="sistema-cursos">
      ...
      <div className="card-header">
        ...
        <h1>Sistema de Cursos Obligatorios</h1>
        <p className="description">
          Esta herramienta facilita el envío de recordatorios de cursos obligatorios según Resolución 3100 desde el correo{' '}
          <a href="mailto:talentohumano@umit.com.co">talentohumano@umit.com.co</a>.
        </p>
      </div>
      ...
      <div 
        ...
        onDrop={handleDrop}
        onClick={() => document.getElementById('file-input-cursos').click()}
      >
      ...
      <div className="action-buttons">
        ...
        >
          {isProcessing ? 'Procesando...' : 'Enviar Correos de Cursos'}
        </button>
